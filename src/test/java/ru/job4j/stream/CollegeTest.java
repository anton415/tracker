...
public class CollegeTest {
    ...
    public void whenAccountIsOptionalNotEmpty() {
        ...
        student.ifPresent(value -> assertThat(value.getGroup(), is("201-18-15")));
    }
    ...
    public void whenSubjectIsOptionalNotEmpty() {
        ...
        College college = new College(students);
        Optional<Subject> subject = college.findBySubjectName("000002", "Sociology");
        subject.ifPresent(value -> assertThat(value.getScore(), is(65)));
    }
}